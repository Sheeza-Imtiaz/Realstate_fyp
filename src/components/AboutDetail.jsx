...
const agents = [
    { name: 'Agent 1', image: '/images/s1.png', phone: '(123) 456-7890', location: 'New York, NY' },
    { name: 'Agent 2', image: '/images/s2.png', phone: '(234) 567-8901', location: 'Los Angeles, CA' },
    { name: 'Agent 3', image: '/images/s3.png', phone: '(345) 678-9012', location: 'Chicago, IL' },
    { name: 'Agent 4', image: '/images/images.jfif', phone: '(456) 789-0123', location: 'Houston, TX' },
    { name: 'Agent 5', image: '/images/images(1).jfif', phone: '(567) 890-1234', location: 'Phoenix, AZ' },
    { name: 'Agent 6', image: '/images/Aver.webp', phone: '(678) 901-2345', location: 'Philadelphia, PA' },
];
