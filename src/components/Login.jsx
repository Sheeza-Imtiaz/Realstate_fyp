...
function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const resp = await axios.post('http://192.168.12.108:8001/real_estate/login/', formData);
      // const resp = await axios.post('http://192.168.12.108:8001/real_estate/login/', formData);
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {!isLoggedIn && (
                    <p className="small mb-1 pb-lg-3 ms-5">
                      <a className="text-muted" href="http://192.168.12.108:8001/real_estate/password_reset/">
                        Forgot password?
                      </a>
                    </p>
                  )}
