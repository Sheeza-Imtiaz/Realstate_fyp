...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        fetchData('http://192.168.12.105:8001/real_estate/users/', setUsers);
        fetchData('http://192.168.12.105:8001/real_estate/allproducts/', setProperties);
        fetchData('http://192.168.12.105:8001/real_estate/contact/', setMessages);
        fetchData('http://192.168.12.105:8001/real_estate/plans/', setPricingCards);
    }, []);
