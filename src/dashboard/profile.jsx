...
const Profile = () => {
    ...
    useEffect(() => {
        if (userId && accessToken) {
            axios.get(`http://192.168.12.108:8001/real_estate/users/${userId}/`, {
                headers: {
            ...
            axios.get(`http://192.168.12.108:8001/real_estate/products/?user_id=${userId}`, {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
            })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(`http://192.168.12.108:8001/real_estate/users/${userId}/`, updatedData, {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
